...
public class FoodClass4Activity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home) {
            Intent homeIntent = new Intent(FoodClass4Activity.this, MainActivity.class);
            homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(homeIntent);
        }
        if (id == R.id.action_emergency) {
            Intent intent = new Intent(FoodClass4Activity.this, EmergencyActivity.class);
    ...
    private Cursor getFood() {
        ...
        Cursor cursor = db.query(FoodContent.TABLE_NAME, COLUMNS, CATEGORY + "== 4 AND " + FOOD_NAME + " LIKE '%" + filter + "%'", null, null, null, null);
...
//        ListView list = getListView();
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(FoodClass4Activity.this, FoodTypeActivity.class);
