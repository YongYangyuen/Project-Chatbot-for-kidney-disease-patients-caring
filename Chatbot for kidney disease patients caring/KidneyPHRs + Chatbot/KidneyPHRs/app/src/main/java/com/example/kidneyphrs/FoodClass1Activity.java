...
public class FoodClass1Activity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home) {
            Intent homeIntent = new Intent(FoodClass1Activity.this, MainActivity.class);
            homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(homeIntent);
        }
        if (id == R.id.action_emergency) {
            Intent intent = new Intent(FoodClass1Activity.this, EmergencyActivity.class);
    ...
    private Cursor getFood() {
        ...
        Cursor cursor = db.query(FoodContent.TABLE_NAME, COLUMNS, CATEGORY + "== 1 AND " + FOOD_NAME + " LIKE '%" + filter + "%'", null, null, null, null);
...
//        ListView list = getListView();
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(FoodClass1Activity.this, FoodTypeActivity.class);
