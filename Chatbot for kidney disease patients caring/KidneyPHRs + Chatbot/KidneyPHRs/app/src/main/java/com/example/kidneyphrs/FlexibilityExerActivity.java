...
public class FlexibilityExerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flexibility_exer);
    ...
    private Cursor getExercise() {
        ...
        Cursor cursor = db.query(TABLE_NAME, COLUMNS, CATAGORY + " == 1 AND " + EXERCISE_NAME + " LIKE '%" + filter +"%'", null, null, null, null);
    ...
    private void showExercise(final Cursor cursor) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(FlexibilityExerActivity.this, ExerciseByTypeActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home) {
            Intent homeIntent = new Intent(FlexibilityExerActivity.this, MainActivity.class);
            homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(homeIntent);
        }
        if (id == R.id.action_emergency) {
            Intent intent = new Intent(FlexibilityExerActivity.this, EmergencyActivity.class);
