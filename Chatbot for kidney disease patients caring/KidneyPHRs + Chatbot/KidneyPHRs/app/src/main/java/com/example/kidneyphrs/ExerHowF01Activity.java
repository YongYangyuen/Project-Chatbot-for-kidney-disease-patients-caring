...
public class ExerHowF01Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_how_f01);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ExerHowF01Activity.this, ExerciseByTypeActivity.class);
        ...
        pGif.setImageResource(R.drawable.f_01);
